$(document).ready(function () {
    ...
    function FreeUpControls() {
        ...
        document.getElementById('txtRes').value = '0';
    }

    function callBasicInfo(id) {
        $.ajax({
            url: "/Account/GetBasicInfo4Co",
            type: "GET",
            data: { id: id },
            traditional: true,
            success: function (result) {
                ...
                if (result.error == "N/A") {
                    ...
                    document.getElementById('txtBal').value = numberWithCommas(result.balance);
                    document.getElementById('txtRes').value = numberWithCommas(result.reserved);
