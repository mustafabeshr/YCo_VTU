...
{
    public class VTUFileLogger : ILogger
    {
        protected readonly VTUFileLoggerProvider vtufileLoggerProvider;

        public VTUFileLogger([NotNull] VTUFileLoggerProvider _vtuFileLoggerProvider)
        {
            vtufileLoggerProvider = _vtuFileLoggerProvider;
        }
        ...
        public void Log<TState>(LogLevel logLevel, EventId eventId, TState state, Exception exception, Func<TState, Exception, string> formatter)
        {
            ...
            Task.Run(async () =>
            {
                ...
                try
                {
                    ...
                    await vtufileLoggerProvider.WriteFileLock.WaitAsync();
                ...
                finally
                {
                    ...
                    vtufileLoggerProvider.WriteFileLock.Release();
                }
            });
        }
    }
