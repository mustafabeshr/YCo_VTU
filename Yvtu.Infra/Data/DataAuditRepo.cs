        ...
        public OpertionResult Create(DataAudit data)
        {
            try
            {
                #region Parameters
                    ...
                    new OracleParameter{ ParameterName = "v_note",OracleDbType = OracleDbType.NVarchar2,  Value = data.Note},
                    new OracleParameter{ ParameterName = "v_old_value",OracleDbType = OracleDbType.NVarchar2,  Value = data.OldValue },
